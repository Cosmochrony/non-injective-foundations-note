...
| **noscale** | No independent dimensional parameter beyond $c_{\mathrm{BI}}$ | proved |
...
- **Note 1 (Spectral Admissibility):** consumes $\mathrm{Heis}_3(\mathbb{Z}/q\mathbb{Z})$, $V_\rho$, the BI bound $A_n \leq c_{\mathrm{BI}}/\sqrt{\lambda_n}$, the parity involution $c \leftrightarrow q-c$.
...
- **Level 2 scale determination.** Proving that every emergent scale (masses, couplings, cosmological constant) is uniquely determined from $c_{\mathrm{BI}}$ and the cascade (noscale Level 2) would make the framework fully predictive with a single dimensional free parameter.
