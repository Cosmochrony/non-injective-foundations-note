...
\begin{document}
  ...
  \section{Motivation and Central Question}
    ...
    established.  The no-scale result supplies a separate conditional rigidity theorem.
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    obtains non-commuting admissible generators from irreducibility, itself conditional on a
    representation-theoretic dictionary for $F_n$.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Axiomatic foundation: Foundation~M}
      ...
      \begin{itemize}
        ...
        irreducibility implies it (HeisenbergStructure Proposition~4.2); from A3 it is therefore
        conditional on the same dictionary.
  ...
  \section{Inputs from Upstream Results}
    ...
    the parity involution on the supplied Heisenberg carrier and Weil action. It neither identifies
  ...
  \section{Outputs to Downstream Branches}
    ...
    \begin{table}[ht]
      ...
      \begin{tabular}{@{}p{5.8cm}p{4.2cm}l@{}}
        ...
        $[X,Y] \neq e$ (under the representation dictionary, $\dim F_n > 1$) & Q1, Q2, HeisStr & C \\
  ...
  \section{Status of Results}
    ...
    \subsection{Conditional results}
      ...
      \begin{enumerate}
        ...
        The non-commutation of the admissible generators inherits this condition.
