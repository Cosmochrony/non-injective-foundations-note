...
\begin{document}
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    obtains non-commuting admissible generators from irreducibility on a fibre of dimension greater
    than one when the pair generates the acting group, the irreducibility itself being conditional
    on a representation-theoretic dictionary for $F_n$.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Axiomatic foundation: Foundation~M}
      ...
      \begin{itemize}
        ...
        Heisenberg group and a non-trivial central character, and on the irreducibility of $F_n$, itself
    ...
    \subsection{No external dimensional scale: noscale}
      ...
      \begin{table}[ht]
        ...
        \begin{tabular}{@{}lp{8.2cm}l@{}}
          ...
          non-trivial central character are supplied; Weil action separate & P / C / supplied \\
  ...
  \section{Status of Results}
    ...
    \subsection{Conditional results}
      ...
      \begin{enumerate}
        ...
        On a fibre of dimension greater than one, the non-commutation of a pair generating the
        acting group inherits this condition.
  ...
  \section{Conclusion}
    ...
    A1--A3 and BI parity.  Supplying that group and a non-trivial central character permits
