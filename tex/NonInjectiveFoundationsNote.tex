...
\begin{document}
  ...
  \section{Motivation and Central Question}
    ...
    incorporated into HeisenbergStructure version~2.1~\cite{Beau2026HeisenbergStructure}
    blocks the centrality step.
  ...
  \section{Position in the Cosmochrony Programme}
    ...
    \begin{itemize}
      ...
      four-dimensional Carnot convergence as geometric inputs. The former Q5a Mosco
      derivation is withdrawn in version~3.2; the non-trivial spatial limit is the open
      hypothesis [H-L].
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    \begin{enumerate}
      ...
      (HeisenbergStructure version~2.1~\cite{Beau2026HeisenbergStructure}).}
  ...
  Emergence) is the foundational no-go theorem.
    ...
    \subsection{Axiomatic foundation: Foundation~M}
      ...
      \begin{itemize}
        ...
        (stated in §5.4, detailed in HeisenbergStructure): conditional on supplying the
        Heisenberg group and central character.  The associated Weil action is separate further
    ...
    \subsection{Heisenberg structure from admissibility: HeisenbergStructure}
      ...
      \begin{quote}
        ...
        $\Heis_3(\mathbb{Z}/q\mathbb{Z})$ for some prime $q$, and $F_n$ carries the claimed
        representation data.
      \end{quote}
      ...
      prime central order.  Stone--von Neumann identifies $\pic$ on $\Hc$ only after the
      Heisenberg group and a non-trivial central character are supplied; the associated Weil
      action remains separate further data.
    ...
    \subsection{Finite carrier-selection obstruction}
      ...
      HeisenbergStructure version~2.1~\cite{Beau2026HeisenbergStructure} isolates the failed inference.
  ...
  \section{Inputs from Upstream Results}
    ...
    adopted with it.
    This input is independent of A1--A4 and is adopted as an explicit hypothesis when defining
    the parity involution inside the supplied Heisenberg/Weil realisation. It neither identifies
    nor selects that realisation from the foundational axioms.
  ...
  \section{Outputs to Downstream Branches}
    ...
    \begin{table}[ht]
      ...
      \begin{tabular}{@{}p{5.8cm}p{4.2cm}l@{}}
        ...
        Associated Weil action on $\Hc$ (separate symplectic data) & Notes 1--3; O-series & C \\
  ...
  \section{Status of Results}
    ...
    \subsection{Proved results}
      ...
      \begin{enumerate}
        ...
        (HeisenbergStructure version~2.1): the $S_3$ construction proves that the properties
      ...
      $\Heis_3(\mathbb{Z}/q\mathbb{Z})$ and a non-trivial central character are supplied,
        Stone--von Neumann theory identifies the corresponding irreducible Heisenberg representation
        $\pic$ on $\Hc$. It does not itself supply the associated Weil action.
    ...
    \subsection{Open hypotheses}
      ...
      \begin{enumerate}
        ...
        Q3 derives a singlet state and correlator only under an explicit diagonal-$2I$
        invariance hypothesis that is not established~\cite{Beau2026q3}.
        ...
        Hilbert space is not derived. Q5a version 3.2 proves a zero-form/no-go result for
        its canonical filtration and leaves the non-trivial spatial limit [H-L] open.
  ...
  \section{Open Deliverables}
    ...
    The Born rule is not established by Q1--Q3; Q3's singlet and correlator are conditional
    on an unestablished diagonal-$2I$ invariance hypothesis.
