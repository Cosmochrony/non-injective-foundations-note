...
\begin{document}
  ...
  \section{Constituent Papers}
    ...
    \subsection{Non-injectivity as structural necessity: ENI}
      ...
      Every non-degenerate distribution $p$ on $\Omega$ has strictly positive projection entropy,
      $S_\Pi(p) = H(p) - H(\Pi_* p) > 0$ when both entropies are finite (Corollary~8).
  ...
  \section{Inputs from Upstream Results}
    ...
    supplied carrier; reading it as Born--Infeld parity is an open identification, since O18
    establishes Born--Infeld parity as a covariance of the response family and leaves the fibre
    identification open.
